...
async def inline_handler(query: types.InlineQuery):
    ...
    data = [
        ...
        {
            "title_tag": "inline_hard_title",
            "description_tag": "inline_hard_description",
            "password_func": pwd.hard,
            "thumb_color": "green"
        },
        {
            "title_tag": "inline_medium_title",
            "description_tag": "inline_medium_description",
            "password_func": pwd.medium,
            "thumb_color": "yellow"
        },
        {
        ...
        {
            "title_tag": "inline_low_title",
            "description_tag": "inline_low_description",
            "password_func": pwd.low,
            "thumb_color": "red"
        },
    ]
    results = []
    for index, item in enumerate(data):
        results.append(
            types.InlineQueryResultArticle(
                ...
                thumb_url=f"https://raw.githubusercontent.com/kraloveckey/"
                          f"passgen-bot/master/img/pwd_{item['thumb_color']}.png",
                thumb_height=64,
                thumb_width=64,
            )
        )
